...
public class WebResolverServiceFactory : WebApplicationFactory<WebResolverService.Program>
{
    private readonly IResolverRepository? _sharedRepository;

    public WebResolverServiceFactory(IResolverRepository? sharedRepository = null)
    {
